...
public class Menus {
  ...
  public void MenuAdministrador() throws InterruptedException {
    ...
    do {
      ...
      consola.escreverFrase("3. Listar cursos/UCs/alunos/professores");
      consola.escreverFrase("4. Atribuir direção de curso/regência de UC");
      consola.escreverFrase("5. Sair");
  ...
  private void menuGestaoProfessores() throws InterruptedException {
    ...
    do {
      ...
      switch (opcao) {
        ...
        case 3:
          numeroMecanografico =
            consola.lerString("Número Mecanográfico do Professor: ");
          Professor professor = universidade.encontrarProfessor(
            numeroMecanografico
          );
          ...
          if (professor != null) {
            ...
            switch (opcao) {
              case 1:
                ...
                consola.escreverFrase(
                  "Nome do Professor alterado com sucesso!"
                );
                ficheiro.guarda_dados(universidade);
                break;
              case 2:
              ...
              case 0:
                consola.escreverFrase(
                  "Voltar ao Menu de Gestão de Professores."
                );
                break;
              default:
                consola.escreverErro("Opção inválida. Tente novamente.");
          ...
          break;
        case 0:
          consola.escreverFrase("Voltar ao Menu Administrador.");
          break;
        default:
          consola.escreverErro("Opção inválida. Tente novamente.");
      }
      ...
      switch (opcao) {
        ...
        case 3:
          ...
          if (curso != null) {
            ...
            consola.escreverFrase(
              "Informações do Curso alteradas com sucesso!"
            );
            ficheiro.guarda_dados(universidade);
          } else {
            consola.escreverErro("Curso não encontrado.");
    ...
    do {
      ...
      switch (opcao) {
        case 1:
          ...
          for (Curso c : cursos) {
            consola.escreverFrase("\t" + c.getDesignacao());
          }
          break;
        case 2:
          nomeCurso = consola.lerString("Nome do Curso: ");
          curso = universidade.encontrarCurso(nomeCurso);
  ...
  /*
    ...
    private void atribuirDirecaoCurso() {
        ...
        if (professor != null) {
            ...
            Curso curso = universidade.getCursos().stream()
                    .filter(c -> c.getDesignacao().equals(designacaoCurso)).findFirst().orElse(null);
    ...
    private void atribuirRegenciaUC() {
        ...
        if (professor != null) {
            ...
            UnidadeCurricular uc = universidade.getCursos().stream()
                    .flatMap(c -> c.getUCs().stream())
                    .filter(u -> u.getDesignacao().equals(designacaoUC)).findFirst().orElse(null);
      ...
      switch (opcao) {
        ...
        case 2:
          ...
          for (Aluno aluno : cursoAssociado.getAlunos()) {
            if (
              aluno.getNumeroMecanografico().equals(numMecanograficoRemover)
            ) {
              alunoRemover = aluno;
              break;
            }
